...
declare function address(callback: (err: Error, addr: { ip: string, ipv6: string, mac: string }) => void): void
declare function address(interfaceName: string, callback: (err: Error, addr: { ip: string, ipv6: string, mac: string }) => void): void
